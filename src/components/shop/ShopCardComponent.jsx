    ...
    <div className="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-3">
      {products.map((product) => (
        <article
          ...
          className="group max-w-[300px] flex flex-col overflow-hidden rounded-2xl border border-gray-200 bg-white shadow-sm transition hover:-translate-y-0.5 hover:shadow-md"
        >
          ...
          <div className="flex flex-1 flex-col gap-3 p-5">
            ...
            <div className="mt-auto flex flex-wrap items-end justify-between gap-3 pt-2">
              ...
              <span className={`rounded-full px-2.5 py-1 text-xs font-medium ${badgeClass("Skincare")}`}>
                Skincare
              </span>
            </div>
            {/* synamic ruote */}
...
// export default async function ShopCardComponent() {
